      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4 mt-5">
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <div className="mt-4 flex gap-2"><Button onClick={() => void syncBalance()} disabled={syncing} className="flex-1"><RefreshCw size={14} className="mr-2" /> Check balance</Button><a href={(settings.voice_provider || settings.provider) === "voicebip" ? "https://voicebip.ng/" : (settings.voice_provider || settings.provider) === "infobip" ? "https://www.infobip.com/" : "https://notify.africa/"} target="_blank" rel="noreferrer" className="flex-1"><Button variant="secondary" className="w-full"><WalletCards size={14} className="mr-2" /> Recharge</Button></a></div>
